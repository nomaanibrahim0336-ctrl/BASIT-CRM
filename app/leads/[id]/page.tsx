    ...
    <div className="space-y-4">
      ...
      <Card>
        ...
        <CardContent className="grid gap-4 sm:grid-cols-2">
          ...
          <Field label="Client Discord Username" value={lead.discordUsername} />
          ...
          <Field label="Hunted By (Lead Gen)" value={lead.generatedBy?.fullName ?? "—"} />
          <Field label="Closed By" value={lead.assignedCloser?.fullName ?? "Unassigned"} />
